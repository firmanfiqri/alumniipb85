    ...
    <div class="wrapper clearfix">
		...
		<nav>
			<ul id="nav" class="sf-menu">
				...
				<li <?php if($lv == 3){echo "class='current-menu-item'";}?>><a href="<?php echo base_url();?>admin/data_peserta">PESERTA EVENT</a></li>
				<!--
				<li <?php if($lv == 4){echo "class='current-menu-item'";}?>><a href="<?php echo base_url();?>admin/konfirmasi_pembayaran">KONFIRMASI PEMBAYARAN</a></li>
				-->
