...
<html class="no-js">
    ...
    <head>
        ...
        <!-- Tweet -->
        <link rel="stylesheet" href="<?php echo base_url(); ?>assets/css/jquery.tweet.css" media="all"  /> 
        <script src="<?php echo base_url(); ?>assets/js/tweet/jquery.tweet.js" ></script> 
        <!-- ENDS Tweet -->

        <!-- superfish -->
        <link rel="stylesheet" media="screen" href="<?php echo base_url(); ?>assets/css/superfish.css" /> 
        <script  src="<?php echo base_url(); ?>assets/js/superfish-1.4.8/js/hoverIntent.js"></script>
        <script  src="<?php echo base_url(); ?>assets/js/superfish-1.4.8/js/superfish.js"></script>
        <script  src="<?php echo base_url(); ?>assets/js/superfish-1.4.8/js/supersubs.js"></script>
        <!-- ENDS superfish -->

        <!-- prettyPhoto -->
        <script  src="<?php echo base_url(); ?>assets/js/prettyPhoto/js/jquery.prettyPhoto.js"></script>
        <link rel="stylesheet" href="<?php echo base_url(); ?>assets/js/prettyPhoto/css/prettyPhoto.css"  media="screen" />
        <!-- ENDS prettyPhoto -->

        <!-- poshytip -->
        <link rel="stylesheet" href="<?php echo base_url(); ?>assets/js/poshytip-1.1/src/tip-twitter/tip-twitter.css"  />
        <link rel="stylesheet" href="<?php echo base_url(); ?>assets/js/poshytip-1.1/src/tip-yellowsimple/tip-yellowsimple.css"  />
        <script  src="<?php echo base_url(); ?>assets/js/poshytip-1.1/src/jquery.poshytip.min.js"></script>
        <!-- ENDS poshytip -->
        ...
        <!-- Less framework -->
        <link rel="stylesheet" media="all" href="<?php echo base_url(); ?>assets/css/lessframework.css"/>
                ...
                <div id="slider-holder" class="clearfix">
                    ...
                    <div class="flexslider home-slider">
                        <ul class="slides">
                            ...
                            <li>
                                <img src="<?php echo base_url();?>assets/img/slides/02.jpg" alt="alt text" />
                                <p class="flex-caption">Pellentesque habitant morbi  feugiat vitae.</p>
                            </li>
                            <li>
                                <img src="<?php echo base_url();?>assets/img/slides/03.jpg" alt="alt text" />
                            </li>
                        </ul>
                    </div>
                    <!-- ENDS slider -->
                ...
                <div class="home-block" >
                    ...
                    <div class="one-third-thumbs clearfix" >
                        <figure>
                            ...
                            <a href="single.html"  class="thumb"><img src="<?php echo base_url();?>assets/img/dummies/featured-1.jpg" alt="Alt text" /></a>
                        </figure>
                        ...
                        <figure>
                            ...
                            <a href="single.html"  class="thumb"><img src="<?php echo base_url();?>assets/img/dummies/featured-2.jpg" alt="Alt text" /></a>
                        </figure>
                        ...
                        <figure class="last">
                            ...
                            <a href="single.html"  class="thumb"><img src="<?php echo base_url();?>assets/img/dummies/featured-3.jpg" alt="Alt text" /></a>
                        </figure>
                        ...
                        <figure>
                            ...
                            <a href="single.html"  class="thumb"><img src="<?php echo base_url();?>assets/img/dummies/featured-4.jpg" alt="Alt text" /></a>
                        </figure>
                        ...
                        <figure>
                            ...
                            <a href="single.html"  class="thumb"><img src="<?php echo base_url();?>assets/img/dummies/featured-5.jpg" alt="Alt text" /></a>
                        </figure>
                        ...
                        <figure class="last">
                            ...
                            <a href="single.html"  class="thumb"><img src="<?php echo base_url();?>assets/img/dummies/featured-6.jpg" alt="Alt text" /></a>
                        </figure>
                ...
                <div class="home-block">
                    ...
                    <div class="one-fourth-thumbs clearfix">
                        ...
                        <figure>
                            ...
                            <a href="single.html"  class="thumb"><img src="<?php echo base_url();?>assets/img/dummies/featured-7.jpg" alt="Alt text" /></a>
                        </figure>
                        ...
                        <figure>
                            ...
                            <a href="single.html"  class="thumb"><img src="<?php echo base_url();?>assets/img/dummies/featured-8.jpg" alt="Alt text" /></a>
                        </figure>
                        ...
                        <figure>
                            ...
                            <a href="single.html"  class="thumb"><img src="<?php echo base_url();?>assets/img/dummies/featured-9.jpg" alt="Alt text" /></a>
                        </figure>
                        ...
                        <figure class="last">
                            ...
                            <a href="single.html"  class="thumb"><img src="<?php echo base_url();?>assets/img/dummies/featured-10.jpg" alt="Alt text" /></a>
                        </figure>
